...
export const skus = [
  ...
  { id: "26", slug: "2025-panini-contenders-football-hobby-box", year: 2025, brand: "Panini", sport: "NFL", set: "Contenders", product: "Hobby Box", releaseDate: "2026-01-21", gradient: ["#1e40af", "#facc15"], description: "Panini Contenders Football. Rookie Ticket autos. The hobby's signature rookie auto chase." , imageUrl: "/products/2025-panini-contenders-football-hobby-box.jpg" },
